...
export function renderInvolvement(data) {
  ...
  function projectActionsMarkup(data, project, ownership) {
    if (ownership === "work") {
  ...
  function projectCardMarkup(data, project, ownership) {
    ...
    return `
      <article class="project-card">
        ...
        <div class="project-actions">
          ${projectActionsMarkup(data, project, ownership)}
        </div>
      </article>
    `;
  }
...
export function renderProjectsPage(data) {
    ...
    const renderGrid = () => {
      ...
      grid.innerHTML = visibleProjects.length
        ? visibleProjects.map((project) => projectCardMarkup(data, project, ownership)).join("")
        : `
            <article class="project-empty">
              ...
              <p class="project-copy">
                ...
                <code>assets/js/data/portfolio-data.js</code>.
              </p>
            </article>
          `;
    };
